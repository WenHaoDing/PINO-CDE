function [hfig,p] = plot3_DisplaceModel2_V3(TPhi,faces,verts,DefScale,isATime,ifColorBar,FigNum)
...
if ~isATime
    ...
    dispVector = dat.DefScale * sqrt( TPhi( :, 1 ) ); % 计算变形矢量
